...
from src.agents.jd_analyzer_agent import jd_agent_node
...
def build_app_graph() -> CompiledStateGraph:
    ...
    workflow.add_node('repo_match_agent', repo_match_agent_node)
    workflow.add_node('activity_agent', analyze_activity)
    workflow.add_node('evaluation_agent', evaluation_agent_node)

    # Define edges (jd_agent -> repo_match_agent -> activity_agent -> evaluation_agent -> END)
    workflow.add_edge('jd_agent', 'repo_match_agent')
    workflow.add_edge('repo_match_agent', 'activity_agent')
    workflow.add_edge('activity_agent', 'evaluation_agent')
